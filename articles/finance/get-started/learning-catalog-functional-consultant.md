...
| 콘텐츠  | 설명 | 포맷  | 기간    |
|----------|-------------|---------|-----------|
| [Success by Design for Dynamics 365 솔루션 사용](/learn/paths/use-success-design/) | FastTrack for Dynamics 365는 고객과 파트너가 Dynamics 365 솔루션을 성공적으로 배포할 수 있도록 설계되었습니다. 이 서비스를 제공하려면 솔루션 설계자는 Success by Design을 사용해야 합니다. 이 학습 경로는 Success by Design 개념을 논의합니다. | 자기 주도적인 무료 온라인 학습 모듈 | 12시간 |
