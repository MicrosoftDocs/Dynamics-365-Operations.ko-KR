---
title: 모집 요청 예제 쿼리
description: 이 항목에서는 Dynamics 365 Human Resources의 모집 요청 엔터티에 대한 예제 쿼리를 제공합니다.
author: jaredha
ms.date: 02/05/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8452215"
---
# <a name="example-query-for-recruiting-request"></a>모집 요청 예제 쿼리
...
이 항목에서는 Dynamics 365 Human Resources의 모집 요청 엔터티에 대한 예제 쿼리를 제공합니다.

다음 쿼리는 GET 작업에서 $expand 쿼리 옵션을 사용하여 지정된 모집 요청 레코드 및 모든 관련 직위, 지정된 요청에 필요한 기술과 교육 요구 사항을 검색하는 방법을 보여줍니다. 예제 응답은 두 직위에 대한 모집 요청과 요청된 직위에 필요한 기술 및 교육을 보여줍니다.
