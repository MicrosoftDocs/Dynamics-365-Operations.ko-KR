...
| [Success by Design for Dynamics 365 솔루션 사용](/learn/paths/use-success-design/) | FastTrack for Dynamics 365는 고객과 파트너가 Dynamics 365 솔루션을 성공적으로 배포할 수 있도록 설계되었습니다. 이 서비스를 제공하려면 솔루션 설계자는 Success by Design을 사용해야 합니다. 이 학습 경로는 Success by Design 개념을 논의합니다. | 자기 주도적인 무료 온라인 학습 경로 | 12시간 |
| [금융 및 운영 앱 구현](/learn/paths/implement-finance-operations/) | 성공적인 금융 및 운영 구현 프로젝트를 관리하기 위한 가장 중요한 요소와 모범 사례를 알아보세요. 프로젝트 방법론을 계획하고 설계하는 첫 번째 단계, FastTrack 서비스의 사용, 개발 전략, 데이터 관리 등, 라이브 전환 후 운영을 유지 관리하고 모니터링하는 최상의 방법에 이르기까지 모든 단계를 다룹니다. | 자기 주도적인 무료 온라인 학습 경로 | 11.5시간 |
...
## <a name="migration-and-upgrade"></a>마이그레이션 및 업그레이드<a name="migration"></a>
...
| 콘텐츠 | 설명 | 포맷 | 기간 |
|---------|-------------|--------|--------|
| [Dynamics 365 Supply Chain Management에서 개별 제조 구성 및 사용](/learn/paths/configure-use-discrete-manufacturing-dyn365-supply-chain-mgmt/) | 회사에서 단순한 제품만 생산하는 경우 정확한 BOM(자재 명세서) 부품이 생산 현장, 정확한 시간 및 적절한 리소스에 도착하여 수동으로 생산 일정을 잡을 수 있습니다. 제조를 위한 기능 컨설턴트는 고객이 생산 수명 주기를 수행하고 제어할 수 있도록 개별 제조를 위해 Dynamics 365 Supply Chain Management를 구성하는 방법을 알아야 합니다. | 자기 주도적인 무료 온라인 학습 경로 | 16.5시간 |
| [Dynamics 365 Supply Chain Management에서 린 제고 구성 및 사용](/learn/paths/configure-use-lean-manufacturing-dyn365-supply-chain-mgmt/) | 린 제고는 지속적인 개선의 여정입니다. 고객이 원하는 것을 고객이 원할 때 정확하게 생산하여 경제적으로 하는 것이 목표입니다. 다양한 공급, 생산 및 소싱 전략을 결합한 통합(혼합 모드) 제조 환경에서 린 제조를 사용할 수 있습니다. 이러한 전략에는 생산 주문, 공정 산업을 위한 배치 주문, 구매 주문 및 이전 주문이 포함됩니다. Dynamics 365 Supply Chain Management의 린 제조 아키텍처는 생산 흐름, 활동 및 칸반 규칙으로 구성됩니다. | 자기 주도적인 무료 온라인 학습 경로 | 12.5시간 |
| [Dynamics 365 Supply Chain Management에서 공정 제조 구성 및 사용](/learn/paths/configure-use-process-manufacturing-dyn365-supply-chain-mgmt/) | 공정 제조는 개별 단위 및 자재 명세서을 사용하는 개별 제조와 달리 공식 및 제조 레시피와 연관됩니다. 공정 제조는 생산이 배치 또는 반연속 공정으로 완료되는 제조 환경에서 사용됩니다. | 자기 주도적인 무료 온라인 학습 경로 | 10.5시간 |
| [Dynamics 365 Supply Chain Management에서 제조 시 창고 관리 사용](/learn/paths/use-warehouse-manufacturing-dyn365-supply-chain-mgmt/) | Dynamics 365 Supply Chain Management의 제조 프로세스에서 창고 관리를 사용하면 회사의 요구 사항에 따라 제조 환경에서 창고 프로세스를 최적화하고 간소화할 수 있습니다. | 자기 주도적인 무료 온라인 학습 경로 | 10.5시간 |
...
| 콘텐츠 | 설명 | 포맷 | 기간 |
|---------|-------------|--------|--------|
| [Dynamics 365 Supply Chain Management에서 제품 및 재고 구성 및 관리](/learn/paths/configure-manage-products-inventory-dyn365-supply-chain-mgmt/) | 제품 정보는 모든 산업 분야에서 공급망 및 소매 애플리케이션의 기둥입니다. 비즈니스 솔루션의 다양한 모듈에서 제품, 제품군, 자재 명세서 및 제품 범주와 관련된 비즈니스 프로세스를 관리하려면 제품별 정보 및 구성이 필요합니다. 재고 보고서는 보유하고 있는 재고의 양을 다양한 방식으로 보여주고 재고 투자를 보다 효과적으로 수행하는 방법을 설명합니다. 기준 계획은 미리 결정된 요소를 기반으로 계획을 간소화하는 데 도움이 되므로 구매, 이전 또는 제조해야 하는 자재를 효율적으로 계획할 수 있습니다. | 자기 주도적인 무료 온라인 학습 경로 | 14시간 |
| [Dynamics 365 Supply Chain Management에서 조달 및 공급업체 구성 및 관리](/learn/paths/configure-manage-procurement-vendors-dyn365-supply-chain-mgmt/) | 공급업체를 찾고 협력하고, 제품을 구매하고, 제품과 서비스의 품질을 보장하는 프로세스는 모두 회사의 명성과 성공에 영향을 미치는 중요한 요소입니다. | 자기 주도적인 무료 온라인 학습 경로 | 14시간 |
| [Dynamics 365 Supply Chain Management에서 영업 및 고객 구성 및 관리](/learn/paths/configure-manage-sales-customers-dyn365-supply-chain-mgmt/) | 고객과 협력하는 프로세스, 판매 프로세스의 수명 주기를 이해하고 판매 계약을 설정하는 프로세스는 모두 회사의 성공에 영향을 미치는 중요한 요소입니다. | 자기 주도적인 무료 온라인 학습 경로 | 7시간 |
| [Dynamics 365 Supply Chain Management에서 기준 계획](/learn/paths/master-planning-supply-chain-management/) | 기준 계획을 통해 기업은 미래 목표를 달성하는 데 필요한 원자재와 용량을 식별하고 균형을 맞출 수 있습니다. 기준 계획은 현재 사용할 수 있는 원자재 및 용량, 생산을 완료하는 데 필요한 원자재 및 용량을 평가합니다. 예를 들어, 생산을 완료하기 전에 제조, 구매, 이전 또는 안전 재고로 확보해야 하는 항목을 식별합니다. | 자기 주도적인 무료 온라인 학습 경로 | 5시간 |
| [Dynamics 365 for Finance and Operations에서 창고 관리 구성 및 작업](/learn/paths/configure-work-warehouse-management-dyn365-supply-chain-mgmt/) | Dynamics 365 Supply Chain Management의 창고 관리는 개별 요구 사항에 따라 창고 프로세스를 최적화하고 간소화하는 데 도움이 되며 재고에 대한 통찰력과 고객 만족도를 높이고 비용을 줄이는 데 도움이 되는 도구를 제공합니다. | 자기 주도적인 무료 온라인 학습 경로 | 8.5시간 |
...
| [과정 MB-330T03-A: Dynamics 365 for Finance and Operations에서 창고 및 운송 관리 구성 및 사용](https://www.microsoft.com/learning/course.aspx?cid=MB-330T03) | 이 과정에서는 Dynamics 365 for Finance and Operations에서 창고 및 운송 관리를 구성하고 사용하는 방법에 대해 설명합니다. | 강사 주도의 대면 또는 온라인 교육, 비용은 지역 및 파트너에 따라 다름 | 1일 |
| [Dynamics 365 Supply Chain Management에 대한 자산 관리 구성](/learn/paths/configure-asset-management-dyn365-supply-chain-mgmt/) | 자산 관리는 회사의 일상적인 운영에 사용되는 자산을 관리하는 데 사용되는 Dynamics 365 Supply Chain Management용 추가 기능입니다. 이러한 자산 유형의 몇 가지 예는 기계, 생산 장비 및 지게차입니다. | 자기 주도적인 무료 온라인 학습 경로 | 7시간 |
| [Dynamics 365 Supply Chain Management를 위한 자산 관리 작업](/learn/paths/work-asset-management-dyn365-supply-chain-mgmt/) | 자산 관리는 회사의 일상적인 운영에 사용되는 자산을 관리하는 데 사용되는 Dynamics 365 Supply Chain Management용 추가 기능입니다. 이러한 자산 유형의 몇 가지 예는 기계, 생산 장비 및 지게차입니다. | 자기 주도적인 무료 온라인 학습 경로 | 12.5시간 |
| [Dynamics 365 Supply Chain Management에서 제품 버전 정보 관리](/learn/paths/manage-product-version-engineering-change-management/) | Dynamics 365 Supply Chain Management용 엔지니어링 변경 관리 추가 기능은 엔지니어링 제품의 수명 주기 동안 제품 버전 정보를 관리하기 위한 구조화된 프로세스를 제공합니다. | 자기 주도적인 무료 온라인 학습 경로 | 4시간 |
| [Dynamics 365 Supply Chain Management 엔지니어링 변경 관리 설정](/learn/paths/set-up-engineering-change-management/) | 오늘날의 제조업체는 제품 수명 주기가 지속적으로 단축되고 품질 및 신뢰성 요구 사항이 증가하며 제품 안전에 대한 관심이 증가하는 세상에서 성공하기 위해 강력한 제품 데이터 관리, 버전 제어 및 엔지니어링 변경 관리가 필요합니다. 이 학습 경로에서 엔지니어링 변경 관리를 설정하는 방법을 알아보세요. | 자기 주도적인 무료 온라인 학습 경로 | 4시간 |
